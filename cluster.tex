...
make their updates after the master and from master's local repository. This approach has advantages, like decreasing internet bandwitch demand since only
...
As expected, this approach has its drawback. A certain ammount of disk space is needed to keep a mirror of CentOS packages locally.
